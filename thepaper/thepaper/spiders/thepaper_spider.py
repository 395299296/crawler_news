...
class ThepaperSpider(scrapy.spiders.Spider):
    ...
    def parse(self, response):
        ...
        load_chosen = re.search(r'data.:."(.*)".+.masonry',html.decode('utf-8'))
        page = 2
        if load_chosen :
    ...
    def parse_news(self,response):
        ...
        if news_txt:
            ...
            if news_about:
                ...
                news_date = news_about.p.next_sibling.next_sibling.text[0:35]
                struct_date = datetime.datetime.strptime(news_date.strip(),"%Y-%m-%d %H:%M")
